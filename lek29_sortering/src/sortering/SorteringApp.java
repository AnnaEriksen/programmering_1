...
public class SorteringApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(tabel));
        InsertionSortering_opg3.insertionSort(tabel);
        System.out.println(Arrays.toString(tabel));
        ...
        //ja, listen bliver sorteret, den bliver sorteret leksikografisk, vi bruger faktisk compareTo(), da man ikke kan bruge ==
