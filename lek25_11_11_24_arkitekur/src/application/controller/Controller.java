...
public class Controller {
     ...
     * Requires: wage >= 0.
     */
    public static Employee createEmployee(String name, int wage, int yearOfEmployment) {
        Employee employee = new Employee(name, wage, yearOfEmployment);
     ...
     */
    public static Employee createEmployee(String name, int wage,int yearOfEmployment , Company company) {
        Employee employee = createEmployee(name, wage, yearOfEmployment);
     ...
     * Requires: wage >= 0.
     */
    public static void updateEmployee(Employee employee, String name, int wage, int yearOfEmployment) {
        employee.setName(name);
        employee.setWage(wage);
        employee.setYearOfEmployment(yearOfEmployment);
    }
