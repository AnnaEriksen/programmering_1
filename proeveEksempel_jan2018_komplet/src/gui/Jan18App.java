...
public class Jan18App {
    ...
    public static void initStorage() {
        ...
        Controller.addTutorTilHold(peter, e17U);
        Controller.addTutorTilHold(niels, e17U);
        Controller.addTutorTilHold(mads, e17B);
        ...
        Controller.addArrangementTilTutor(fodbold, niels);
        Controller.addArrangementTilTutor(brætspil, lone);
        Controller.addArrangementTilTutor(brætspil, niels);
        Controller.addArrangementTilTutor(mindeparken, mads);
        Controller.addArrangementTilTutor(mindeparken, anders);

        // Test udskrifter
//        for (String info : dmu.tutorOversigt()) {
//            System.out.println(info);
//        }
        // Test udskrift til fil
//        Controller.tutorOversigtTilFil("Jan2018/src/gui/TutorOversigt.txt");
